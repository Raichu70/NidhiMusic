...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "UNK ᴍᴜsɪᴄ")

OWNER_ID = list(map(int, getenv("OWNER_ID", "5889411003").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/TANDAV_KING")
